class PhotoExpansionWorker
  ...
  def generate_images
    ...
    when @photo.landscape?
      generate_image(:standard_image, :homepage_image, "2000x", "-quality 80")
      generate_image(:standard_image, :large_image, "1500x", "-quality 80")
    when @photo.portrait? 
      generate_image(:standard_image, :homepage_image, "2000x1400#", "-quality 80")
      generate_image(:standard_image, :large_image, "x1000", "-quality 80")
    else
      generate_image(:standard_image, :homepage_image, "2000x1400#", "-quality 80")
      generate_image(:standard_image, :large_image, "1500x1500>", "-quality 80")
    end
